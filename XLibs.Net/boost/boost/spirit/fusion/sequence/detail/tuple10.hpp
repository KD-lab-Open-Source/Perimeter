...
#include <boost/spirit/fusion/sequence/detail/tuple_element_traits.hpp>
#include <boost/spirit/fusion/sequence/detail/tuple_get_traits.hpp>
...
namespace boost { namespace fusion
{
    namespace detail
    {
        ...
        struct tuple_access<0>
        {
            ...
            static typename tuple_access_result<0, Tuple>::type
            get(Tuple& t)
            {
        ...
        {
            template <typename Tuple>
            static typename tuple_access_result<1, Tuple>::type
            get(Tuple& t)
            {
        ...
        {
            template <typename Tuple>
            static typename tuple_access_result<2, Tuple>::type
            get(Tuple& t)
            {
