...
//главное меню
    ...
    SQSH_MM_MOD_LIST_SCR,
    SQSH_MM_MOD_PUBLISH_SCR,
    SQSH_MM_MOD_MENU_SCR,
    SQSH_MM_COMMUNITY_SCR,
	SQSH_MM_LOAD_SCR,
	SQSH_MM_LOAD_IN_GAME_SCR,
    SQSH_MM_CONTROL_EDITOR_SCR,
    SQSH_MM_CONTROL_EDITOR_INGAME_SCR,
...
//	SQSH_MM_GRAPHICS_LOD,
	...
	SQSH_MM_SOUND_SOUNDEFFECTS, //Unused
	SQSH_MM_SOUND_SOUNDEFFECTS_COMBO, //Unused
	SQSH_MM_SOUND_SOUNDVOLUME,
	SQSH_MM_SOUND_SOUNDVOLUME_SLIDER,
	SQSH_MM_SOUND_MUSIC, //Unused
	SQSH_MM_SOUND_MUSIC_COMBO, //Unused
    ...
    //mods menu
    SQSH_MM_MOD_MENU_BTN,
    SQSH_MM_MOD_LIST_BTN,
    SQSH_MM_MOD_PUBLISH_BTN,
    SQSH_MM_MOD_GUIDE_BTN,
    SQSH_MM_BACK_FROM_MOD_MENU_BTN,

    //mods list
    SQSH_MM_MOD_LIST_LIST,
    SQSH_MM_MOD_LIST_APPLY_BTN,
    SQSH_MM_MOD_LIST_ENABLE_COMBO,
    SQSH_MM_MOD_LIST_DESCR_TXT,
    SQSH_MM_MOD_LIST_ENABLE_BTN,
    SQSH_MM_MOD_LIST_SEPARATOR,
    SQSH_MM_BACK_FROM_MOD_LIST_BTN,
    
    //mods publish
    SQSH_MM_MOD_PUBLISH_LIST,
    SQSH_MM_MOD_PUBLISH_PUBLISH_BTN,
    SQSH_MM_MOD_PUBLISH_DESCR_TXT,
    SQSH_MM_BACK_FROM_MOD_PUBLISH_BTN,
    ...
    SQSH_MM_CONTROL_EDITOR_BTN,
    SQSH_MM_CONTROL_EDITOR_LIST,
    SQSH_MM_CONTROL_EDITOR_CHANGE_BTN,
    SQSH_MM_CONTROL_EDITOR_RESTORE_BTN,
    SQSH_MM_CONTROL_EDITOR_DELETE_BTN,
    SQSH_MM_CONTROL_EDITOR_APPLY_BTN,
    SQSH_MM_CONTROL_EDITOR_DESCR_TXT,
    SQSH_MM_BACK_FROM_CONTROL_EDITOR_BTN,

    //ingame menu control editor
    SQSH_MM_CONTROL_EDITOR_INGAME_BTN,
    SQSH_MM_CONTROL_EDITOR_INGAME_LIST,
    SQSH_MM_CONTROL_EDITOR_INGAME_CHANGE_BTN,
    SQSH_MM_CONTROL_EDITOR_INGAME_RESTORE_BTN,
    SQSH_MM_CONTROL_EDITOR_INGAME_DELETE_BTN,
    SQSH_MM_CONTROL_EDITOR_INGAME_APPLY_BTN,
    SQSH_MM_CONTROL_EDITOR_INGAME_DESCR_TXT,
    SQSH_MM_BACK_FROM_CONTROL_EDITOR_INGAME_BTN,
