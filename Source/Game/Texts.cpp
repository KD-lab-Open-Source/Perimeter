...
void qdTextDB::load_supplementary_texts(const std::string& locale) {
    ...
    if (startsWith(locale, "russian")) {
        load_lines({
           ...
           "Interface.Menu.Messages.Multiplayer.ChatTip=Нажмите &00FFFFInsert&FFFFFF чтобы написать игрокам из своего клана, &00FFFFControl + Insert&FFFFFF или &00FFFFControl + Space&FFFFFF чтобы написать всем игрокам.",
        ...
        load_lines({
           ...
           "Controls.Input.MouseLeftButton=Left mouse",
           "Controls.Input.MouseRightButton=Right mouse",
           "Controls.Input.MouseMiddleButton=Middle mouse",
           ...
           "Interface.Menu.Messages.Multiplayer.ChatTip=Press &00FFFFInsert&FFFFFF to chat with your clan players, &00FFFFControl + Insert&FFFFFF or &00FFFFControl + Space&FFFFFF to chat with all players.",
