/********************************************************************
	...
	purpose:	Ѕазовый объект дл€ режимов, которые работают с одной цепочкой
*********************************************************************/
#pragma once
...
private:
	//! цепочка, с которой выполн€етс€ работа
	TriggerChain* triggerChain_;
	//! Ћогика, владеюща€ режимом работы
	TriggerEditorLogic* triggerEditorLogic_;

	//! Ёлемент, на который кликнули мышкой
	int baseElement_;
protected:
