/********************************************************************
	...
	file ext:	h
	Powerd by:	»люха при идейном руководстве и моральной поддержке of Scmorr
	
	purpose:	Ѕазовый класс дл€ художников базового режима работы
*********************************************************************/
#pragma once
...
public:
	...
	//рисует линк с €кор€ми, позвол€ющими измен€ть место положение св€зи
	virtual void drawAnchoredLink(TriggerEditorView* view, HDC dc, 
		Trigger const& link_owner, TriggerLink const& link) const = 0;
	//рисует линк, когда мы его т€нем от одного элемента к другому
	...
	//возвращает кисть соответствующую св€зи данного тип
