...
cVisGeneric				*gb_IVisGeneric=0;	// верхн€€ библиотека визуализации
...
//	gb_IVisGeneric->SetStrencilShadow(true);
	...
	gb_Camera->SetFrustum(							// устанавливаетс€ пирамида видимости
		&Vect2f(0.5f,0.5f),							// центр камеры
		&sRectangle4f(-0.5f,-0.5f,0.5f,0.5f),		// видима€ область камеры
		&Vect2f(1.f,1.f),							// фокус камеры
		&Vect2f(10.0f,3000.0f)						// ближайший и дальний z-плоскости отсечени€
		);

	// создаетс€ источник света, иначе кромешна€ тьма и объектов не видно
