...
public:
	...
	inline Vect3f& GetPos(void *pVertex,int n)				{ return ((Vect3f*)((char*)pVertex+n*vb->ptr->VertexSize))[0]; }
	inline Vect3f& GetNormal(void *pVertex,int n)			{ return ((Vect3f*)((char*)pVertex+n*vb->ptr->VertexSize))[1]; }
	inline Vect2f& GetTexel(void *pVertex,int n)			{ return ((Vect2f*)((char*)pVertex+n*vb->ptr->VertexSize))[3]; }
	inline sVertexXYZNT1& GetVertex(void *pVertex,int n)	{ return ((sVertexXYZNT1*)((char*)pVertex+n*vb->ptr->VertexSize))[0]; }
