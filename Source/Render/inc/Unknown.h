...
//	1	..	7	- интерфейсы классов
	KIND_UI_VISGENERIC		=		1,				// базова€ библиотека визуализации
	KIND_UI_RENDERDEVICE	=		2,				// интерфейс дл€ работы с растеризацией
//	8	..	15	- классы дл€ работы с текстурами
//	16	..	23	- классы-объекты наследованы от cIUnkObj
	...
	KIND_POLYGRID			=		20,				// cPolyGrid - регул€рна€ полигональна€ сетка
	...
	// классы спецэффектов высокого уровн€ реализации
	KIND_PIPE				=		24,				// cPipe - класс "водопровод" - св€занные линии
	KIND_GLOBALFOG			=		27,				// cGlobalFog - класс глобального тумана
	KIND_OBJLIGHT			=		28,				// cObjLight -  класс-подобъект источника света
	KIND_ENVGRID			=		29,				// cEnvGrid -  класс полигональна€ карта горизонта
	...
	KIND_LINE3D				=		39,				// cLine3d - Ёффект линий
//	50	..	63	- прочие классы 
	...
	KIND_ELASTICSPHERE		=		59,				// класс дл€ работы с ElasticSphere
	KIND_ELASTICLINK		=		60,				// класс дл€ работы с OscillatingSphere
...
// базовый класс дл€ всех
// любой класс наследованный как TYPE_CLASS_POINTER, должен уметь удал€тьс€ по обращению к Release()
class cUnknownClass
#ifdef C_CHECK_DELETE
: public cCheckDelete
#endif //C_CHECK_DELETE
