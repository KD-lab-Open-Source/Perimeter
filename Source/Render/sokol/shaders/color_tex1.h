...
/*
    ...
    Cmdline:
        sokol-shdc --input color_texture.glsl --output color_tex1.h --slang glsl410:glsl300es:hlsl5:metal_macos:metal_ios:metal_sim --format=sokol --reflection --ifdef --module color_tex1
