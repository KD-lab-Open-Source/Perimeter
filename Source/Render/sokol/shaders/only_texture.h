...
/*
    ...
    Cmdline: sokol-shdc --input only_texture.glsl --output only_texture.h --slang glsl330:glsl300es:hlsl5:metal_macos:metal_ios:metal_sim --format=sokol --reflection --ifdef --module only_texture

    Overview:

        Shader program 'program':
            Get shader desc: only_texture_program_shader_desc(sg_query_backend());
            Vertex shader: vs
                Attribute slots:
                    ATTR_only_texture_vs_vs_position = 0
                    ATTR_only_texture_vs_vs_texcoord0 = 1
                Uniform block 'only_texture_vs_params':
                    C struct: only_texture_only_texture_vs_params_t
                    Bind slot: SLOT_only_texture_only_texture_vs_params = 0
            Fragment shader: fs
                Image 'un_tex0':
                    Type: SG_IMAGETYPE_2D
                    Sample Type: SG_IMAGESAMPLETYPE_FLOAT
                    Bind slot: SLOT_only_texture_un_tex0 = 0
                Sampler 'un_sampler0':
                    Type: SG_SAMPLERTYPE_FILTERING
                    Bind slot: SLOT_only_texture_un_sampler0 = 0
    ...
    Shader descriptor structs:
        ...
        sg_shader program = sg_make_shader(only_texture_program_shader_desc(sg_query_backend()));
    ...
    Vertex attribute locations for vertex shader 'vs':
        ...
        sg_pipeline pip = sg_make_pipeline(&(sg_pipeline_desc){
            .layout = {
                .attrs = {
                    [ATTR_only_texture_vs_vs_position] = { ... },
                    [ATTR_only_texture_vs_vs_texcoord0] = { ... },
                },
            },
            ...});
    ...
    Image bind slots, use as index in sg_bindings.vs.images[] or .fs.images[]
        ...
        SLOT_only_texture_un_tex0 = 0;

    Sampler bind slots, use as index in sg_bindings.vs.sampler[] or .fs.samplers[]

        SLOT_only_texture_un_sampler0 = 0;

    Bind slot and C-struct for uniform block 'only_texture_vs_params':

        only_texture_only_texture_vs_params_t only_texture_vs_params = {
            .un_mvp = ...;
        };
        sg_apply_uniforms(SG_SHADERSTAGE_[VS|FS], SLOT_only_texture_only_texture_vs_params, &SG_RANGE(only_texture_vs_params));
...
#include <stddef.h>
  ...
  #endif
#endif
#define ATTR_only_texture_vs_vs_position (0)
#define ATTR_only_texture_vs_vs_texcoord0 (1)
#define SLOT_only_texture_un_tex0 (0)
#define SLOT_only_texture_un_sampler0 (0)
#define SLOT_only_texture_only_texture_vs_params (0)
#pragma pack(push,1)
SOKOL_SHDC_ALIGN(16) typedef struct only_texture_only_texture_vs_params_t {
    Mat4f un_mvp;
} only_texture_only_texture_vs_params_t;
#pragma pack(pop)
#if defined(SOKOL_GLCORE33)
/*
    #version 330
    
    uniform vec4 only_texture_vs_params[4];
    ...
    void main()
    {
        gl_Position = mat4(only_texture_vs_params[0], only_texture_vs_params[1], only_texture_vs_params[2], only_texture_vs_params[3]) * vec4(vs_position, 1.0);
        fs_uv0 = vs_texcoord0;
    }
    
*/
static const char only_texture_vs_source_glsl330[359] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x33,0x30,0x0a,0x0a,0x75,0x6e,
    0x69,0x66,0x6f,0x72,0x6d,0x20,0x76,0x65,0x63,0x34,0x20,0x6f,0x6e,0x6c,0x79,0x5f,
    ...
    0x34,0x28,0x6f,0x6e,0x6c,0x79,0x5f,0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x5f,0x76,
    0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x5b,0x30,0x5d,0x2c,0x20,0x6f,0x6e,0x6c,
    0x79,0x5f,0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x5f,0x76,0x73,0x5f,0x70,0x61,0x72,
    0x61,0x6d,0x73,0x5b,0x31,0x5d,0x2c,0x20,0x6f,0x6e,0x6c,0x79,0x5f,0x74,0x65,0x78,
    0x74,0x75,0x72,0x65,0x5f,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x5b,0x32,
    0x5d,0x2c,0x20,0x6f,0x6e,0x6c,0x79,0x5f,0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x5f,
    ...
    0x2c,0x20,0x31,0x2e,0x30,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x66,0x73,0x5f,0x75,
...
*/
static const char only_texture_fs_source_glsl330[186] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x33,0x30,0x0a,0x0a,0x75,0x6e,
...
*/
static const char only_texture_vs_source_glsl300es[362] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x30,0x30,0x20,0x65,0x73,0x0a,
    0x0a,0x75,0x6e,0x69,0x66,0x6f,0x72,0x6d,0x20,0x76,0x65,0x63,0x34,0x20,0x6f,0x6e,
    0x6c,0x79,0x5f,0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x5f,0x76,0x73,0x5f,0x70,0x61,
    ...
    0x6d,0x61,0x74,0x34,0x28,0x6f,0x6e,0x6c,0x79,0x5f,0x74,0x65,0x78,0x74,0x75,0x72,
    0x65,0x5f,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,0x73,0x5b,0x30,0x5d,0x2c,0x20,
    0x6f,0x6e,0x6c,0x79,0x5f,0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x5f,0x76,0x73,0x5f,
    0x70,0x61,0x72,0x61,0x6d,0x73,0x5b,0x31,0x5d,0x2c,0x20,0x6f,0x6e,0x6c,0x79,0x5f,
    0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x5f,0x76,0x73,0x5f,0x70,0x61,0x72,0x61,0x6d,
    0x73,0x5b,0x32,0x5d,0x2c,0x20,0x6f,0x6e,0x6c,0x79,0x5f,0x74,0x65,0x78,0x74,0x75,
...
*/
static const char only_texture_fs_source_glsl300es[253] = {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x30,0x30,0x20,0x65,0x73,0x0a,
...
/*
    cbuffer only_texture_vs_params : register(b0)
    {
...
*/
static const char only_texture_vs_source_hlsl5[831] = {
    0x63,0x62,0x75,0x66,0x66,0x65,0x72,0x20,0x6f,0x6e,0x6c,0x79,0x5f,0x74,0x65,0x78,
...
*/
static const char only_texture_fs_source_hlsl5[553] = {
...
/*
    ...
    vertex main0_out main0(main0_in in [[stage_in]], constant only_texture_vs_params& _19 [[buffer(0)]])
    {
        main0_out out = {};
...
*/
static const char only_texture_vs_source_metal_macos[574] = {
    ...
    0x6e,0x6c,0x79,0x5f,0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x5f,0x76,0x73,0x5f,0x70,
    ...
    0x6e,0x74,0x20,0x6f,0x6e,0x6c,0x79,0x5f,0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x5f,
...
*/
static const char only_texture_fs_source_metal_macos[423] = {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
...
*/
static const char only_texture_vs_source_metal_ios[574] = {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
...
*/
static const char only_texture_fs_source_metal_ios[423] = {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
...
*/
static const char only_texture_vs_source_metal_sim[574] = {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
...
*/
static const char only_texture_fs_source_metal_sim[423] = {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
  ...
  #error "Please include sokol_gfx.h before only_texture.h"
#endif
static inline const sg_shader_desc* only_texture_program_shader_desc(sg_backend backend) {
  #if defined(SOKOL_GLCORE33)
  if (backend == SG_BACKEND_GLCORE33) {
    ...
    if (!valid) {
      ...
      desc.vs.source = only_texture_vs_source_glsl330;
      desc.vs.entry = "main";
      desc.vs.uniform_blocks[0].size = 64;
      desc.vs.uniform_blocks[0].layout = SG_UNIFORMLAYOUT_STD140;
      desc.vs.uniform_blocks[0].uniforms[0].name = "only_texture_vs_params";
      desc.vs.uniform_blocks[0].uniforms[0].type = SG_UNIFORMTYPE_FLOAT4;
      desc.vs.uniform_blocks[0].uniforms[0].array_count = 4;
      desc.fs.source = only_texture_fs_source_glsl330;
      desc.fs.entry = "main";
      ...
      desc.label = "only_texture_program_shader";
    }
    return &desc;
  }
  #endif /* SOKOL_GLCORE33 */
  ...
  if (backend == SG_BACKEND_GLES3) {
    ...
    if (!valid) {
      ...
      desc.attrs[0].name = "vs_position";
      desc.attrs[1].name = "vs_texcoord0";
      desc.vs.source = only_texture_vs_source_glsl300es;
      desc.vs.entry = "main";
      desc.vs.uniform_blocks[0].size = 64;
      desc.vs.uniform_blocks[0].layout = SG_UNIFORMLAYOUT_STD140;
      desc.vs.uniform_blocks[0].uniforms[0].name = "only_texture_vs_params";
      desc.vs.uniform_blocks[0].uniforms[0].type = SG_UNIFORMTYPE_FLOAT4;
      desc.vs.uniform_blocks[0].uniforms[0].array_count = 4;
      desc.fs.source = only_texture_fs_source_glsl300es;
      desc.fs.entry = "main";
      desc.fs.images[0].used = true;
      desc.fs.images[0].multisampled = false;
      desc.fs.images[0].image_type = SG_IMAGETYPE_2D;
  ...
  if (backend == SG_BACKEND_D3D11) {
    ...
    if (!valid) {
      ...
      desc.vs.source = only_texture_vs_source_hlsl5;
      desc.vs.d3d11_target = "vs_5_0";
      desc.vs.entry = "main";
      desc.vs.uniform_blocks[0].size = 64;
      desc.vs.uniform_blocks[0].layout = SG_UNIFORMLAYOUT_STD140;
      desc.fs.source = only_texture_fs_source_hlsl5;
  ...
  if (backend == SG_BACKEND_METAL_MACOS) {
    ...
    if (!valid) {
      valid = true;
      desc.vs.source = only_texture_vs_source_metal_macos;
      desc.vs.entry = "main0";
      desc.vs.uniform_blocks[0].size = 64;
      desc.vs.uniform_blocks[0].layout = SG_UNIFORMLAYOUT_STD140;
      desc.fs.source = only_texture_fs_source_metal_macos;
      desc.fs.entry = "main0";
      desc.fs.images[0].used = true;
      desc.fs.images[0].multisampled = false;
      desc.fs.images[0].image_type = SG_IMAGETYPE_2D;
  ...
  if (backend == SG_BACKEND_METAL_IOS) {
    ...
    if (!valid) {
      valid = true;
      desc.vs.source = only_texture_vs_source_metal_ios;
      desc.vs.entry = "main0";
      desc.vs.uniform_blocks[0].size = 64;
      desc.vs.uniform_blocks[0].layout = SG_UNIFORMLAYOUT_STD140;
      desc.fs.source = only_texture_fs_source_metal_ios;
      desc.fs.entry = "main0";
      desc.fs.images[0].used = true;
      desc.fs.images[0].multisampled = false;
      desc.fs.images[0].image_type = SG_IMAGETYPE_2D;
  ...
  if (backend == SG_BACKEND_METAL_SIMULATOR) {
    ...
    if (!valid) {
      valid = true;
      desc.vs.source = only_texture_vs_source_metal_sim;
      desc.vs.entry = "main0";
      desc.vs.uniform_blocks[0].size = 64;
      desc.vs.uniform_blocks[0].layout = SG_UNIFORMLAYOUT_STD140;
      desc.fs.source = only_texture_fs_source_metal_sim;
      desc.fs.entry = "main0";
      desc.fs.images[0].used = true;
      desc.fs.images[0].multisampled = false;
      desc.fs.images[0].image_type = SG_IMAGETYPE_2D;
...
static inline int only_texture_program_attr_slot(const char* attr_name) {
  (void)attr_name;
...
static inline int only_texture_program_image_slot(sg_shader_stage stage, const char* img_name) {
...
static inline int only_texture_program_sampler_slot(sg_shader_stage stage, const char* smp_name) {
...
static inline int only_texture_program_uniformblock_slot(sg_shader_stage stage, const char* ub_name) {
  (void)stage; (void)ub_name;
  if (SG_SHADERSTAGE_VS == stage) {
    if (0 == strcmp(ub_name, "only_texture_vs_params")) {
      return 0;
    }
  }
  return -1;
}
static inline size_t only_texture_program_uniformblock_size(sg_shader_stage stage, const char* ub_name) {
  (void)stage; (void)ub_name;
  if (SG_SHADERSTAGE_VS == stage) {
    if (0 == strcmp(ub_name, "only_texture_vs_params")) {
      return sizeof(only_texture_only_texture_vs_params_t);
    }
  }
  return 0;
}
static inline int only_texture_program_uniform_offset(sg_shader_stage stage, const char* ub_name, const char* u_name) {
...
static inline sg_shader_uniform_desc only_texture_program_uniform_desc(sg_shader_stage stage, const char* ub_name, const char* u_name) {
  (void)stage; (void)ub_name; (void)u_name;
