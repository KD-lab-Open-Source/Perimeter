...
/*
    ...
    Cmdline:
        sokol-shdc --input normal_texture.glsl --output normal.h --slang glsl410:glsl300es:hlsl5:metal_macos:metal_ios:metal_sim --format=sokol --reflection --ifdef --module normal
