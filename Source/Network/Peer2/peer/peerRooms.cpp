...
)
{
	...
	if(connection->connected)
		chatLeaveChannel(connection->chat, ROOM, reason);
...
)
{
	...
	if(titleRoom)
	{
		...
		{
			chatSetChannelKeys(connection->chat, connection->rooms[TitleRoom], connection->nick, 1, &key, (const char **)&titleRoom);
	...
	if(groupRoom)
	{
		...
		{
			chatSetChannelKeys(connection->chat, connection->rooms[GroupRoom], connection->nick, 1, &key, (const char **)&groupRoom);
	...
	if(stagingRoom)
	{
		...
		{
			chatSetChannelKeys(connection->chat, connection->rooms[StagingRoom], connection->nick, 1, &key, (const char **)&stagingRoom);
